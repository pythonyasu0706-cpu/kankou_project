...
document.addEventListener("DOMContentLoaded", () => {
    ...
    getPlaceWeather(
        ...
        getPlaceWeather(
        { lat: 33.58650763843376, lon: 130.3765841848311 },
        "ohori-weather"
    );
        getPlaceWeather(
        { lat: 33.58650763843376, lon: 130.3765841848311 },
        ...
        getPlaceWeather(
        { lat: 33.593644949724855, lon: 130.35168524200876 },
        "fukuokatower-weather"
    );
        getPlaceWeather(
        { lat: 33.52178626549702, lon: 130.5348432124952 },
        "dazaifu-weather"
    );
        getPlaceWeather(
        { lat: 33.58612881591459, lon: 130.44899960932278 },
        "fukuokaairport-weather"
    );
